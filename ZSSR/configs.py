...
class Config:
    ...
    input_path = local_dir = '../data/test_data'
...
X2_ONE_JUMP_IDEAL_CONF.input_path = '../data/example_with_gt'
...
X2_IDEAL_WITH_PLOT_CONF.input_path = '../data/example_with_gt'
...
X2_GRADUAL_IDEAL_CONF.input_path = '../data/example_with_gt'
...
X2_GIVEN_KERNEL_CONF.input_path = '../data/kernel_example'
...
X2_REAL_CONF.input_path = '../data/real_example'
